...
<img src="http://cmvasfalto.com.mx/anpasaweb/assets/templates/anpasa/imagenes/banner_tierras.jpg">
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1364489769,
    'editedby' => 1,
    'editedon' => 1371689802,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1370818980,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<link rel=\'stylesheet\' href="assets/templates/anpasa/css/cabecera.css">

<link rel=\'stylesheet\' href="assets/templates/anpasa/css/contenidos.css">

<link rel=\'stylesheet\' href="assets/templates/anpasa/css/fuentes.css">
<link rel="stylesheet" href="assets/templates/anpasa/css/estilo.css">
<link rel="stylesheet" href="assets/templates/anpasa/css/slider.css">
<link rel="stylesheet" href="assets/templates/anpasa/css/menu.css">
<link rel="stylesheet" href="assets/templates/anpasa/css/footer.css" />


<script type="text/javascript" src="assets/templates/anpasa/js/jquery-1.8.1.min.js"> </script>
<script type="text/javascript" src="assets/templates/anpasa/js/jquery.colorbox-min.js"></script>
...
<div class="bloque-ciudades">
  ...
  'elementCache' => 
  array (
    '[[$currentCrumbTpl?id=`17`&type=`document`&contentType=`text/html`&pagetitle=`Pararrayos`&longtitle=``&description=``&alias=``&link_attributes=``&published=`1`&pub_date=`0`&unpub_date=`0`&parent=`0`&isfolder=``&introtext=``&content=`<article>
<div id="page">
...
</article>`&richtext=`1`&template=`4`&menuindex=`3`&searchable=`1`&cacheable=`1`&createdby=`1`&createdon=`2013-03-28 10:56:09`&editedby=`1`&editedon=`2013-06-19 19:56:42`&deleted=``&deletedon=`0`&deletedby=`0`&publishedon=`2013-06-09 18:03:00`&publishedby=`1`&menutitle=``&donthit=``&privateweb=``&privatemgr=``&content_dispo=`0`&hidemenu=``&class_key=`modDocument`&context_key=`web`&content_type=`1`&uri=``&uri_override=`0`&hide_children_in_tree=`0`&show_in_tree=`1`&properties=`5910ba8d5e42751dd705bbadc7f198c8`&link=`index.php?id=17`]]' => '<li class="bc_li"> > Pararrayos</li>',
    '[[$containerTpl?crumbs=`<li class="bc_li"> > Pararrayos</li>`]]' => '<ul id="breadcrumb" itemprop="breadcrumb">
  <li class="bc_li"> <a href="http://cmvasfalto.com.mx/anpasaweb/">Andamios y Pararrayos S.A. de C.V</a></li>
  <li class="bc_li"> > Pararrayos</li>
</ul> ',
    '[[BreadCrumb?  
...
<ul id="breadcrumb" itemprop="breadcrumb">
  ...
  <li class="bc_li"> > Pararrayos</li>
    ...
    '[[~83]]' => 'index.php?id=83',
    '[[~151]]' => 'index.php?id=151',
    '[[~187]]' => 'index.php?id=187',
    '[[~264]]' => 'index.php?id=264',
