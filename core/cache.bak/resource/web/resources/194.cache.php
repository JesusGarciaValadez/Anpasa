<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1365381610,
    'editedby' => 1,
    'editedon' => 1372799789,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1365381660,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<head>
    <title>ANPASA</title>
    <link rev="made" href="mailto:webmaster@anpasa.com" />
...
<base href="http://cmvasfalto.com.mx/anpasaweb//" />
<title>Andamios y Pararrayos S.A. de C.V</title>

<link href="assets/templates/anpasa/css/estilos.css" rel=\'stylesheet\' type=\'text/css\'>
<link href="assets/templates/anpasa/css/fuentes.css" rel=\'stylesheet\' type=\'text/css\'>
<link href="assets/templates/anpasa/css/cabecera.css" rel=\'stylesheet\' type=\'text/css\'>
<link href="assets/templates/anpasa/css/menu.css" rel=\'stylesheet\' type=\'text/css\'>
<link href="assets/templates/anpasa/css/contenidos.css" rel=\'stylesheet\' type=\'text/css\'>
<link href="assets/templates/anpasa/css/footer.css" rel=\'stylesheet\' type=\'text/css\'>
<link href="assets/templates/anpasa/css/contacto.css" rel=\'stylesheet\' type=\'text/css\'>
<link href="assets/templates/anpasa/css/ajaxsearch.css" rel=\'stylesheet\' type=\'text/css\'>





<!-- inicio script para contacto -->
	...
	$(\'#send\').click(function(){ 
		...
		<script>
			$(document).ready(function(){
				...
				$(".iframe").colorbox({iframe:true, innerWidth:1000, innerHeight:450});
...
<div id="cabecera">
		<div class="botonera">
			<div class="izquierda">
			<a href="./index.php" class="logo"><img src="imagenes/logo.png" /></a>
			</div>
			<div class="centro">

<div id="menu">				
[[!Wayfinder? &startId=`0` &level=`2` &outerTpl=`menu1` &innerTpl=`menu2` &rowTpl=`menu3` &hereClass=`active` ]]
</div>
			...
			<div class="derecha">
				<div class="buscador">
[[!SimpleSearchForm? &tpl=`SimpleSearchForm` &landing=`24`]]

			<span class="contacto-gris">Contamos con presencia a nivel </span><span class="contacto-naranja">nacional</span><br>
			<span class="contacto-gris">Cont&aacute;ctanos al </span><span class="contacto-naranja">
01800-7176247

</span> <a href="mailto:info@anpasa.com"><span class="contacto-naranja">info@anpasa.com</span></a><br>
...
<ul id="breadcrumb" itemprop="breadcrumb">
  <li class="bc_li"> <a href="http://cmvasfalto.com.mx/anpasaweb/">Andamios y Pararrayos S.A. de C.V</a></li>
  <li class="bc_li"> > <a href="index.php?id=17">Pararrayos</a></li><li class="bc_li"> > <a href="index.php?id=107">Sistemas de Protección VS sobretensiones</a></li><li class="bc_li"> > Galería</li>
</ul> 
...
<footer>
<div id="footer-interiores">
	<div class="centrado-footer">
		<div class="redes">
			<div class="derecha">
			<div class="compartir">Compartir</div>
<div>
				<a onClick="window.open(\'http://twitter.com/home?status=Mensaje para twitter http://anpasa.com\',\'sharer\',\'toolbar=0,status=0,width=548,height=325\');" href="javascript: void(0)">
				<img src="assets/templates/anpasa/imagenes/twitter.png" /> 
				</a>
				<a onClick="window.open(\'http://www.facebook.com/sharer.php?s=100&amp;p[title]=Anpasa en Facebook&amp;p[summary]=Mensaje de anpasa para facebook.&amp;p[url]=http://www.apnasa.com&amp;&amp;p[images][0]=http://cmvasfalto.com.mx/anpasa/css/img/logo.png\',\'sharer\',\'toolbar=0,status=0,width=548,height=325\');" href="javascript: void(0)"><img src="assets/templates/anpasa/imagenes/facebook.png"/></a>			</a>
		...
		<div class="desde">
			<center>Desde 1969 seguridad, servicio y calidad</center>
		</div>



<div class="block-ciudades" >
<div class="bloque-ciudades">
		<div id="ciudades">
			<ul>
				<li class="primera"> Cancún</li>
				<li> Culiacán</li>
				<li> Hermosillo</li>
				<li> Guadalajara</li>
				<li> León</li>
		...
		<div class="derechos-reservados">
			&copy; ANPASA S.A. de C.V. 2013 Todos los derechos reservados
		</div>
	</div>
</div>
</footer>
  ...
  'elementCache' => 
  array (
    '[[$linkCrumbTpl?id=`17`&type=`document`&contentType=`text/html`&pagetitle=`Pararrayos`&longtitle=``&description=``&alias=``&link_attributes=``&published=`1`&pub_date=`0`&unpub_date=`0`&parent=`0`&isfolder=``&introtext=``&content=`<article>
<div id="page">
...
<tr>
<td >
<table background="imagenes/slide/pararrayos/izquierda.jpg" height="450px" width="1123px">
<tr>
<td >
...
<tr>
<td >
<table background="imagenes/slide/pararrayos/central-1.png" height="450px" width="195px">
<tr>
<td >
...
<td >
<table background="imagenes/slide/pararrayos/central.jpg" height="450px" width="1123px">
<tr>
<td >
<div class="boton-centro"></div>
...
<tr>
<td >
<table background="imagenes/slide/pararrayos/derecha-1.png" height="450px" width="195px">
<tr>
<td >
</td>
</tr>
...
<td >
<table background="imagenes/slide/pararrayos/derecha.jpg" height="450px" width="1123px">
<tr>
<td >
...
<div class="centrado">
<div class="descripción-general">
<div class="descripción-general-titulo mayusculas naranja">Pararrayos</div>
<br>
<div>
<div class="descripción-general-texto-pararrayos"  style="float:left; width="300px;">
<p>Un pararrayos es un elemento activo o pasivo cuyo objetivo es atraer la descarga atmosférica en forma de rayo y canalizar la descarga eléctrica hacia tierra, de modo tal que no cause daños a construcciones o personas. 
<br><br>
El principio del funcionamiento de los pararrayos consiste en la concentración de cargas conocido como efecto corona y desarrollado naturalmente en la punta de ciertas asperezas o terminales, que permitirá el arranque de descargas ascendentes dirigidas hacia la nube llamados trazadores ascendentes. 
<br><br>
El trazador ascendente que contacte al primer trazador descendente venido de la nube determinará la posición del canal ionizado que permitirá la circulación de la corriente del rayo, siguiendo así un camino de menor resistividad eléctrica, por lo cual un metal se convierte en un camino favorable al paso de la corriente eléctrica y si éste se encuentra sólidamente aterrizado a tierra logrará dispersar la energía absorbida por el encuentro de ambos trazadores.
</div>
...
<a href="[[~264]]">
<img src="http://cmvasfalto.com.mx/anpasaweb/assets/templates/anpasa/imagenes/banner_tierras.jpg">
</a>
...
</article>`&richtext=`1`&template=`4`&menuindex=`3`&searchable=`1`&cacheable=`1`&createdby=`1`&createdon=`2013-03-28 10:56:09`&editedby=`1`&editedon=`2013-06-19 19:56:42`&deleted=``&deletedon=`0`&deletedby=`0`&publishedon=`2013-06-09 18:03:00`&publishedby=`1`&menutitle=``&donthit=``&privateweb=``&privatemgr=``&content_dispo=`0`&hidemenu=``&class_key=`modDocument`&context_key=`web`&content_type=`1`&uri=``&uri_override=`0`&hide_children_in_tree=`0`&show_in_tree=`1`&properties=`12f4e6020bf12b731ec404b8f6db8c01`&link=`index.php?id=17`]]' => '<li class="bc_li"> > <a href="index.php?id=17">Pararrayos</a></li>',
    '[[$linkCrumbTpl?id=`107`&type=`document`&contentType=`text/html`&pagetitle=`Sistemas de Protección VS sobretensiones`&longtitle=``&description=``&alias=`107`&link_attributes=`sistemas-de-proteccion`&published=`1`&pub_date=`0`&unpub_date=`0`&parent=`17`&isfolder=`1`&introtext=``&content=`<div id="contenidos">
<div class="izquierda">
<div class="titulo mayusculas"><br /><img src="assets/templates/anpasa/imagenes/contenidos/icono_titulo.jpg" alt="" width="52" height="43" /> Características</div>
<div class="texto">
<p>Fenomenos<br />Los descargadores de sobretensión están destinados a limitar las sobrecargas transitorias provocadas por caídas de rayos o por maniobras realizadas sobre la red eléctrica.</p>
<p>En efecto, las caídas de rayos pueden provocar estos fenómenos directamente (por ejemplo: golpe de rayo sobre las líneas de alimentación Alta Tensión aéreas) o indirectamente por acoplamiento:</p>
<p>•Acoplamiento resistivo (o galvánico) debido a una diferencia de potencial.<br />•Acoplamiento inductivo debido a campos magnéticos que afectan a los conductores cercanos</p>
<p>Por otra parte, las sobrecargas transitorias tienen una forma específica (rigidez del frente de corriente del rayo, sobre todo para los golpes de rayos subsiguientes), que no permite a otros elementos de seguridad eléctricos (cuchillas, interruptores, disyuntores...) proteger eficazmente la instalación contra los riesgos de “rayos”. Los descargadores de sobretensión habitualmente utilizan descargadores de gas o varistores de oxido de Zinc.</p>
<p>Finalmente, hay que señalar que los fenómenos de sobrecargas no atañen únicamente a las redes eléctricas sino también a :</p>
<p>• Las redes telefónicas<br />• Las redes informáticas<br />Las redes de transmisiones de datos</p>
<p>Sobretensiones transitorias<br />A fin de evitar devastadores daños a sus  instalaciones y equipos eléctricamente  sensibles (comunicación, cómputo, electrónica digital, etc.) a consecuencia de    inducciones electromagnéticas generadas, no sólo es indispensable contar con un Sistema Eficiente de Pararrayos como PREVECTRON, el cual disipa la energía a tierra  de cualquier impacto directo, sino también se debe contar con un Sistema de Protección Contra Sobretensiones, comúnmente llamados supresores de voltaje en baja tensión (SPD), que minimicen las consecuencias de los voltajes transitorios que acompañan el fenómeno del rayo, y que se caracterizan por su corta duración,  crecimiento rápido y valores de cresta muy elevados (hasta varios cientos de kv).</p>
<p>Si la descarga ha alcanzado cualquier cable conductor en un punto remoto, todos los conductores que acceden desde el exterior hasta su instalación son susceptibles de facilitar el camino a las sobretensiones transitorias, provocando perturbaciones en la alimentación de todos los sistemas conectados. Dicha descarga es  capaz de  propagarse en un radio de varios kilómetros y su dispersión en la tierra eleva su potencial, induciendo fuertes sobretensiones en los cables subterráneos y  aumentando la tensión en las tomas de tierra.</p>
<p> </p>
<p> </p>
<p> </p>
</div>
...
<div class="derecha"><img src="assets/templates/anpasa/imagenes/contenidos/andamio_colgante_mecanico.png" alt="" width="327" height="524" /></div>
</div>`&richtext=`1`&template=`5`&menuindex=`2`&searchable=`1`&cacheable=`1`&createdby=`1`&createdon=`2013-04-02 18:09:20`&editedby=`1`&editedon=`2013-06-27 20:41:22`&deleted=``&deletedon=`0`&deletedby=`0`&publishedon=`2013-03-24 23:23:00`&publishedby=`1`&menutitle=`Sistemas de Protección  `&donthit=``&privateweb=``&privatemgr=``&content_dispo=`0`&hidemenu=``&class_key=`modDocument`&context_key=`web`&content_type=`1`&uri=``&uri_override=`0`&hide_children_in_tree=`0`&show_in_tree=`1`&properties=`05eb66531e50cfff226452e9bf13bc0b`&link=`index.php?id=107`]]' => '<li class="bc_li"> > <a href="index.php?id=107">Sistemas de Protección VS sobretensiones</a></li>',
    '[[$currentCrumbTpl?id=`194`&type=`document`&contentType=`text/html`&pagetitle=`Galería`&longtitle=``&description=``&alias=`107`&link_attributes=``&published=`1`&pub_date=`0`&unpub_date=`0`&parent=`107`&isfolder=``&introtext=``&content=``&richtext=`1`&template=`5`&menuindex=`4`&searchable=`1`&cacheable=`1`&createdby=`1`&createdon=`2013-04-07 19:40:10`&editedby=`1`&editedon=`2013-07-02 16:16:29`&deleted=``&deletedon=`0`&deletedby=`0`&publishedon=`2013-04-07 19:41:00`&publishedby=`1`&menutitle=``&donthit=``&privateweb=``&privatemgr=``&content_dispo=`0`&hidemenu=``&class_key=`modDocument`&context_key=`web`&content_type=`1`&uri=``&uri_override=`0`&hide_children_in_tree=`0`&show_in_tree=`1`&properties=`7ebd442fae582dfe16520675a209b30a`&link=`index.php?id=194`]]' => '<li class="bc_li"> > Galería</li>',
    '[[$containerTpl?crumbs=`<li class="bc_li"> > <a href="index.php?id=17">Pararrayos</a></li><li class="bc_li"> > <a href="index.php?id=107">Sistemas de Protección VS sobretensiones</a></li><li class="bc_li"> > Galería</li>`]]' => '<ul id="breadcrumb" itemprop="breadcrumb">
  <li class="bc_li"> <a href="http://cmvasfalto.com.mx/anpasaweb/">Andamios y Pararrayos S.A. de C.V</a></li>
  <li class="bc_li"> > <a href="index.php?id=17">Pararrayos</a></li><li class="bc_li"> > <a href="index.php?id=107">Sistemas de Protección VS sobretensiones</a></li><li class="bc_li"> > Galería</li>
</ul> ',
    '[[BreadCrumb?  
...
&maxCrumbTpl=`maxCrumbTpl`

]]' => '<ul id="breadcrumb" itemprop="breadcrumb">
  <li class="bc_li"> <a href="http://cmvasfalto.com.mx/anpasaweb/">Andamios y Pararrayos S.A. de C.V</a></li>
  <li class="bc_li"> > <a href="index.php?id=17">Pararrayos</a></li><li class="bc_li"> > <a href="index.php?id=107">Sistemas de Protección VS sobretensiones</a></li><li class="bc_li"> > Galería</li>
</ul> ',
    '[[$cabecera]]' => '<div id="cabecera">
		<div class="botonera">
			<div class="izquierda">
			<a href="./index.php" class="logo"><img src="imagenes/logo.png" /></a>
			</div>
...
<ul id="breadcrumb" itemprop="breadcrumb">
  ...
  <li class="bc_li"> > <a href="index.php?id=17">Pararrayos</a></li><li class="bc_li"> > <a href="index.php?id=107">Sistemas de Protección VS sobretensiones</a></li><li class="bc_li"> > Galería</li>
    ...
    '[[*alias]]' => '107',
    '[[$footer-gris]]' => '<div id="footer-interiores">
	<div class="centrado-footer">
		<div class="redes">
			<div class="derecha">
			<div class="compartir">Compartir</div>
...
&maxCrumbTpl=`maxCrumbTpl`
      ...
      array (
        ...
        array (
          ...
          'category' => 3,
          'cache_type' => 0,
          'snippet' => '<div id="footer-interiores">
	<div class="centrado-footer">
		<div class="redes">
			<div class="derecha">
			<div class="compartir">Compartir</div>
...
<div class="bloque-ciudades">
		...
		<div class="derechos-reservados">
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<div id="footer-interiores">
	<div class="centrado-footer">
		<div class="redes">
			<div class="derecha">
			<div class="compartir">Compartir</div>
