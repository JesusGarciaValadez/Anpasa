<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<div id="contacto">
<div class="formulario">
<div class="centrado">
<div class="bloque-formulario">
<div class="bloque-contacto-correos"><span class="encabezado-contenidos">contacto</span><br /> <img src="imagenes/contacto/icono_sobre_contacto.jpg" alt="" /><br /> 

<a class="correo" href="mailto:andamios@anpasa.com?subject=contacto">andamios@anpasa.com</a><br>
<a class="correo" href="mailto:multi@anpasa.com?subject=contacto">multi@anpasa.com</a><br>
<a class="correo" href="mailto:pararrayos@anpasa.com?subject=contacto">pararrayos@anpasa.com</a><br>

<a class="correo" href="mailto:info@anpasa.com?subject=contacto">info@anpasa.com</a><br>
...
<form id="ajax-form" action="mail-it.php" method="post" name="ajax-form">

<div class="contacto-izquierdo">

<input id="name" onfocus="if(this.value==this.defaultValue)this.value=\'\';" onblur="if(this.value==\'\')this.value=this.defaultValue;" type="text" name="name" value="Nombre: *" /> 
<label for="email"> 

<span id="err-email" class="error">Por favor, escribe una dirección de correo válida.</span> 

<span id="err-emailvld" class="error">La dirección de correo debe se válida</span> </label> 

<input id="email" onfocus="if(this.value==this.defaultValue)this.value=\'\';" onblur="if(this.value==\'\')this.value=this.defaultValue;" type="text" name="email" value="Correo" />
<br> 

<input id="name" onfocus="if(this.value==this.defaultValue)this.value=\'\';" onblur="if(this.value==\'\')this.value=this.defaultValue;" type="text" name="name" value="Giro de la empresa" /> 

<br> <input id="empresa" onfocus="if(this.value==this.defaultValue)this.value=\'\';" onblur="if(this.value==\'\')this.value=this.defaultValue;" type="text" name="empresa" value="Nombre de la empresa " /> <br> 
<input id="telefono" onfocus="if(this.value==this.defaultValue)this.value=\'\';" onblur="if(this.value==\'\')this.value=this.defaultValue;" type="text" name="telefono" value="Teléfono" />

</div>

<div class="contacto-izquierdo">

<input id="ciudad" onfocus="if(this.value==this.defaultValue)this.value=\'\';" onblur="if(this.value==\'\')this.value=this.defaultValue;" type="text" name="ciudad" value="Ciudad" /> 
<br> 

<label class="pregunta-formulario">¿En qué producto y/o servicio está interesado?</label> 
...
<td><td><span style="font-family: Trebuchet; font-size: 11px; color: #606e6e; ">Andamios</span>
...
<td><td><span style="font-family: Trebuchet; font-size: 11px; color: #606e6e; ">Pararrayos</span>
...
<td><span style="font-family: Trebuchet; font-size: 11px; color: #606e6e; ">Multi</span>
</td>
</tr>
</table>


<textarea id="message" onfocus="if(this.value==this.defaultValue)this.value=\'\';" onblur="if(this.value==\'\')this.value=this.defaultValue;" name="message">Escriba aquí un mensaje o comentario...</textarea> <br /> 

<button id="send" class="boton"></button>


<div id="err-form" class="error">Hubo un problema enviando el coreo</div>
<div id="err-timedout" class="error">El tiempo de espera en el servidor se agotó.</div>
<div id="err-state" class="error"> </div>
...
<div id="ajaxsuccess">
<h2>Su mensaje ha sido enviado.<br /> ¡Muchas gracias!</h2>
</div>
<!-- fin de formulario de contacto --></div>
</div>
</div>
</div>
<div id="contacto">
...
<div class="oficina"><span class="titulo mayusculas">casa matriz</span> <br /> <span class="ciudad mayusculas"> méxico</span><br />
<div class="direccion">Av. Constituyentes NO. 1060<br /> Lomas Altas C.P. 11950<br /> México, D.F.<br /> TEL: 52 59 41 04 / Fax EXT. 271<br /> FAX directo: 52 59 27 75</div>

<a class="iframe cboxElement" href="index.php?id=260">
<div class="trebuchet naranja" style="float: left;"><img src="assets/templates/anpasa/css/pin.png" alt="" /></div>
<div class="ubicacion" style="float: left;">ver ubicación</div>
</a>

</div>
<div class="oficina"><span class="titulo mayusculas">almacén general</span><br /> <span class="ciudad mayusculas"> lerma</span><br />
<div class="direccion">Calle Lerma 123<br /> Col. Lerma C.P.11950<br /> Lerma, Estado de México<br /> TEL: 52 59 41 04</div>
<a class="iframe cboxElement" href="index.php?id=263">
<div class="trebuchet naranja" style="float: left;"><img src="assets/templates/anpasa/css/pin.png" alt="" /></div>
<div class="ubicacion" style="float: left;">ver ubicación</div>
</a>
</div>
<div class="oficina"><span class="ciudad mayusculas">Cancún</span><br />
<div class="direccion">Acanceh 7 Mza. 8<br /> Super Manzana 97<br /> Zona Industrial<br /> Cancún, Quintana ROO C.P. 77530<br /> cancun@anpasa.com<br /> TEL: 01 998 886 5175<br /> FAX: 01 998 886 8113</div>

<a class="iframe cboxElement" href="index.php?id=257">
<div class="trebuchet naranja" style="float: left;"><img src="assets/templates/anpasa/css/pin.png" alt="" /></div>
<div class="ubicacion" style="float: left;">ver ubicación</div>
</a>
...
<div class="columna-contacto">
<div class="oficina"><br /> <span class="ciudad mayusculas">hermosillo</span><br />
<div class="direccion">Lampazos 83 Esq. Calle Pilares<br /> Col. San Luis<br /> Hermosillo, Sonora C.P. 83160<br /> hermosillo@anpasa.com<br /> TEL: (662) 2100 208</div>
<a class="iframe cboxElement" href="index.php?id=262">
<div class="trebuchet naranja" style="float: left;"><img src="assets/templates/anpasa/css/pin.png" alt="" /></div>
<div class="ubicacion" style="float: left;">ver ubicación</div>
</a>
</div>
<div class="oficina"><br /> <span class="ciudad mayusculas">PUEBLA</span><br />
<div class="direccion">42 Poniente 1104<br /> Col. Las Cuartillas<br /> Puebla, Puebla C.P. 72050<br /> puebla@anpasa.com<br /> TEL: 01 222 220 5849<br /> FAX: 01 222 220 5826</div>
<a class="iframe cboxElement" href="index.php?id=260">
<div class="trebuchet naranja" style="float: left;"><img src="assets/templates/anpasa/css/pin.png" alt="" /></div>
<div class="ubicacion" style="float: left;">ver ubicación</div>
</a>
</div>
<div class="oficina"><span class="ciudad mayusculas">QUERETARO</span>
<div class="direccion">Blvd. Bernardo Quintana 149 Int. C<br /> Col. Loma Dorada<br /> Querétaro, Querétaro C.P. 76060<br /> queretaro@anpasa.com<br /> TEL: 01 442 223 0479<br /> FAX: 01 442 223 3734</div>
<a class="iframe cboxElement" href="index.php?id=261">
<div class="trebuchet naranja" style="float: left;"><img src="assets/templates/anpasa/css/pin.png" alt="" /></div>
<div class="ubicacion" style="float: left;">ver ubicación</div>
</a>
</div>
...
<div class="oficina"><br /> <span class="ciudad mayusculas">GUADALAJARA</span><br />
<div class="direccion">Marco Polo 2861<br /> Col. 18 de Marzo<br /> Guadalajara, Jalisco C.P. 44960<br /> guadalajara@anpasa.com<br /> TEL: 01 333 645 6080<br /> FAX: 01 333 645 6280</div>
<a class="iframe cboxElement" href="index.php?id=259">
<div class="trebuchet naranja" style="float: left;"><img src="assets/templates/anpasa/css/pin.png" alt="" /></div>
<div class="ubicacion" style="float: left;">ver ubicación</div>
</a>
</div>

<div class="oficina"><br /> <span class="ciudad mayusculas">LEÓN</span><br />
 <div class="direccion">Tarragona 714 B<br /> Col. Vista Hermosa<br /> 
  León, Guanajuato C.P. 37330<br />      leon@anpasa.com<br /> TEL: 01 477 777 7827<br /> 
  FAX: 01 447 771 3233</div>
  <a class="iframe cboxElement" href="index.php?id=258">
 <div class="trebuchet naranja" style="float: left;"><img src="assets/templates/anpasa/css/pin.png" alt="" /></div>
 <div class="ubicacion" style="float: left;">ver ubicación</div>
  </a>
</div>
...
<div class="oficina">
<span class="ciudad mayusculas">Culiacán</span><br />
 <div class="direccion">Ing. Jose Maria Lopez Ruiz<br />      
jlopez@anpasa.com<br /> 
TEL:6679960598<br /> 
</div>
...
<br>
<div class="oficina">
<span class="ciudad mayusculas">Veracruz</span><br />
 <div class="direccion">
Alejandra Chávez Nieto. <br>
achavez@anpasa.com<br>
Cel: 2222721724 
</div>
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1364489788,
    'editedby' => 1,
    'editedon' => 1372800050,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1370819040,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<div class="bloque-ciudades">
  ...
  'elementCache' => 
  array (
    '[[$currentCrumbTpl?id=`19`&type=`document`&contentType=`text/html`&pagetitle=`Contacto`&longtitle=``&description=``&alias=`1000`&link_attributes=``&published=`1`&pub_date=`0`&unpub_date=`0`&parent=`0`&isfolder=``&introtext=``&content=`<div id="contacto">
<div class="formulario">
<div class="centrado">
<div class="bloque-formulario">
<div class="bloque-contacto-correos"><span class="encabezado-contenidos">contacto</span><br /> <img src="imagenes/contacto/icono_sobre_contacto.jpg" alt="" /><br /> 
...
</div>`&richtext=`1`&template=`5`&menuindex=`5`&searchable=`1`&cacheable=`1`&createdby=`1`&createdon=`2013-03-28 10:56:28`&editedby=`1`&editedon=`2013-07-02 16:20:50`&deleted=``&deletedon=`0`&deletedby=`0`&publishedon=`2013-06-09 18:04:00`&publishedby=`1`&menutitle=``&donthit=``&privateweb=``&privatemgr=``&content_dispo=`0`&hidemenu=``&class_key=`modDocument`&context_key=`web`&content_type=`1`&uri=``&uri_override=`0`&hide_children_in_tree=`0`&show_in_tree=`1`&properties=`ea30beb9cdefb3af6d04e9f2818847f3`&link=`index.php?id=19`]]' => '<li class="bc_li"> > Contacto</li>',
    '[[$containerTpl?crumbs=`<li class="bc_li"> > Contacto</li>`]]' => '<ul id="breadcrumb" itemprop="breadcrumb">
  <li class="bc_li"> <a href="http://cmvasfalto.com.mx/anpasaweb/">Andamios y Pararrayos S.A. de C.V</a></li>
  <li class="bc_li"> > Contacto</li>
</ul> ',
    '[[BreadCrumb?  
